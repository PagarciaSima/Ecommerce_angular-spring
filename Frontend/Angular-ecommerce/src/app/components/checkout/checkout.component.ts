  ...
  setupStripePaymentForm() {
    ...
    this.cardElement.on('change', (event: any) => {
      ...
      if (event.complete) {
        ...
        this.displayError.classList.remove('alert', 'alert-danger', 'mt-1');
      } else if (event.error) {
        // show validation error to customer
        this.displayError.textContent = event.error.message;
        this.displayError.classList.add('alert', 'alert-danger', 'mt-1');
      }
        ...
        (paymentIntentResponse) => {
          this.stripe.confirmCardPayment(
            ...
            if(result.error){
              ...
              alert(`There was an eror: ${result.error.message}`);
